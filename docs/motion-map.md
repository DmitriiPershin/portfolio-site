...
- Cursor light: `266 px`, `0.5` maximum opacity, `0.12` position interpolation, and 600 ms enter/exit fade.
...
- Numeric ribbons: `0.9 s`, `cubic-bezier(0.22, 1, 0.36, 1)`, and `45 ms` per-digit stagger; final DOM text remains available to assistive technology.
